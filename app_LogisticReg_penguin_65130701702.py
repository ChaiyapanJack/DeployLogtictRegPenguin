...
# Load model
with open('LogisticReg_penguin_65130701702.pkl', 'rb') as file:
...
culmen_length_input = st.slider('Enter culmen length:', 0, 50, 25)
culmen_depth_input = st.slider('Enter culmen depth in mm :',0,50,25)
flipper_length_input = st.slider('Enter flipper length in mm :', 0,200, 100)
body_mass_input = st.slider('Enter body mass in g :', 1000,5000, 2500)
